...
def ec2_tags_dict_to_list_of_dict_key_value_elements(mydict):
    ...
    ret = []
    for key in mydict:
        ret.append({'Key': key, 'Value': mydict[key], 'PropagateAtLaunch' : True})
    return ret
...
class FilterModule(object):
    ...
    def filters(self):
        return {
            'ec2tagsdict2items': ec2_tags_dict_to_list_of_dict_key_value_elements
        }
